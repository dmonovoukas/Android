...
import com.example.ircombination.MainActivity;
import com.example.ircombination.checkKeypad;
...
public class MainActivity extends Activity {
  private static final String TAG = "bluetooth2";
	...
	private String alarmCode = "1234";
    private String status = "1";
    private String led = "1";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    upvol.setOnClickListener(new OnClickListener() {
		@Override
		public void onClick(View view) {
    ...
    downvol.setOnClickListener(new OnClickListener() {
		@Override
		public void onClick(View view) {
	   ...
	   h = new Handler() {
	        public void handleMessage(android.os.Message msg) {
	            ...
	            case RECIEVE_MESSAGE:                                                   // if receive massage
	              ...
	              //  int findingK = sb.indexOf("k");										// Just find K
	              /*  if (endOfLineIndex == 9) {                                            // if end-of-line,
	                    String sbprint = sb.substring(0, endOfLineIndex);               // extract string
	                    sb.delete(0, sb.length()); 
	                    
	                    alarmCode = sbprint.substring(0, 4);
	                    speaker = sbprint.substring(4, 5);
	                    status = sbprint.substring(5, 6);
	                    led = sbprint.substring(6, 7);
	                    
	                    Integer sum = Integer.parseInt(sbprint.substring(7,9));
	                    Integer addThemAll = Character.getNumericValue(alarmCode.charAt(0))+ Character.getNumericValue(alarmCode.charAt(1)) + Character.getNumericValue(alarmCode.charAt(2)) + Character.getNumericValue(alarmCode.charAt(3)) +Integer.parseInt(status)+Integer.parseInt(led)+Integer.parseInt(speaker);
	                    
	                    if(sum != addThemAll)
	                    {
	                    	Toast.makeText(getBaseContext(), "failed to update, please retry", Toast.LENGTH_LONG).show();
